...
import { CpuChipIcon, BoltIcon, ShieldExclamationIcon } from "@heroicons/react/24/outline";
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-right">
            <span className="text-[10px] font-black opacity-30 uppercase tracking-widest block mb-1">On-Chain Threshold</span>
        ...
        <div className="bg-base-200/50 rounded-lg p-3 border border-base-300/50 flex-grow">
          <div className="flex items-start gap-2">
            ...
            <div>
              <span className="text-[10px] font-black opacity-40 uppercase tracking-widest block mb-1 underline">AI Reasoning</span>
        ...
        <div className="mt-4 flex items-center justify-between">
          <div className="flex items-center gap-1">
            <div className={`w-1.5 h-1.5 rounded-full ${risk?.source === 'offline' ? 'bg-error' : 'bg-success'} animate-pulse`} />
